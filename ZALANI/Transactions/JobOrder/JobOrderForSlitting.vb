...
Public Class JobOrderForSlitting
    ...
    Private Sub JobOrderForSlitting_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        Try
            ...
            If EDIT = True Then
                ...
                Dim OBJCLSINCENTIVE As New ClsJobOrderForSlitting
            ...
            For Each row As Windows.Forms.DataGridViewRow In GRIDJO.Rows
                If row.Cells(0).Value <> Nothing Then
                    ...
                    Else
                        ...
                        MOTHERSIZE = GSM & "|" & row.Cells(GMOTHERSIZE.Index).Value.ToString
    ...
    Private Function ERRORVALID() As Boolean
        ...
        If lbllocked.Visible = True And UserName <> "Admin" Then
            EP.SetError(lbllocked, "Job Order for Slitting done, Delete Checking First")
            bln = False
        End If
    ...
    Private Sub cmddelete_Click(sender As Object, e As EventArgs) Handles cmddelete.Click
        ...
        Try
            ...
            If lbllocked.Visible = True Then
                MsgBox("Unable To Delete, Job Order for Conversion is Locked", MsgBoxStyle.Critical)
                Exit Sub
            End If
            ...
            If EDIT = True Then
                If USERDELETE = False Then
                    ...
                    Exit Sub
                End If
                TEMPMSG = MsgBox("Delete Job Order for Conversion?", MsgBoxStyle.YesNo)
                If TEMPMSG = vbYes Then
                    ...
                    Dim ClsINCTAG As New ClsJobOrderForSlitting()
                    ClsINCTAG.alParaval = alParaval
                    IntResult = ClsINCTAG.Delete()
                    MsgBox("Job Order for Conversion Deleted")
                    clear()
                    EDIT = False
                End If
            Else
...
LINE1:
            ...
            If TEMPJONO > 0 Then
                EDIT = True
                JobOrderForSlitting_Load(sender, e)
            Else
                clear()
                EDIT = False
            End If
...
LINE1:
    ...
    Sub getmax_JONO()
        Dim DTTABLE As New DataTable
        DTTABLE = getmax(" isnull(max(JO_NO),0) + 1 ", "JOBFORSLITTING", "  AND JO_cmpid=" & CmpId & " and JO_yearid=" & YearId)
    ...
    Private Sub OpenToolStripButton_Click(sender As Object, e As EventArgs) Handles OpenToolStripButton.Click
        Try
            ...
            Dim objINVDTLS As New JobOrderForSlittingDetails
    ...
    Private Sub JobOrderForSlitting_KeyDown(sender As Object, e As KeyEventArgs) Handles Me.KeyDown
    ...
    Private Sub TXTGSM_KeyPress(sender As Object, e As KeyPressEventArgs) Handles TXTGSM.KeyPress, TXTMOTHERSIZE.KeyPress, TXTWASTAGEPER.KeyPress
    ...
    Private Sub TXTSIZE_KeyPress(sender As Object, e As KeyPressEventArgs) Handles TXTSIZE.KeyPress, TXTQTY.KeyPress
