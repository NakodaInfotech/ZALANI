...
Imports BL
Public Class JobOrderForLamination
    ...
    Private Sub JobOrderForLamination_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        Try
            ...
            If EDIT = True Then
                ...
                Dim OBJCLSINCENTIVE As New ClsJobOrderForLamination
    ...
    Private Function ERRORVALID() As Boolean
        ...
        If lbllocked.Visible = True Then
            EP.SetError(lbllocked, "Product Issue Done, Delete Checking First")
            bln = False
        End If
    ...
    Private Sub cmddelete_Click(sender As Object, e As EventArgs) Handles cmddelete.Click
        ...
        Try
            If lbllocked.Visible = True Then
                MsgBox("Unable To Delete, Job Order for Lamination is Locked", MsgBoxStyle.Critical)
                Exit Sub
            End If
            ...
            If EDIT = True Then
                ...
                TEMPMSG = MsgBox("Delete Job Order for Lamination?", MsgBoxStyle.YesNo)
                If TEMPMSG = vbYes Then
                    ...
                    Dim ClsINCTAG As New ClsJobOrderForLamination()
                    ClsINCTAG.alParaval = alParaval
                    IntResult = ClsINCTAG.Delete()
                    MsgBox("Job Order for Lamination Deleted")
                    clear()
                    EDIT = False
                End If
            Else
    ...
    Sub getmax_JONO()
        Dim DTTABLE As New DataTable
        DTTABLE = getmax(" isnull(max(JO_NO),0) + 1 ", "JOBFORLAMINATION", "  AND JO_cmpid=" & CmpId & " and JO_yearid=" & YearId)
    ...
    Private Sub OpenToolStripButton_Click(sender As Object, e As EventArgs) Handles OpenToolStripButton.Click
        Try
            ...
            Dim objINVDTLS As New JobOrderForLaminationDetails
    ...
    Private Sub JobOrderForLamination_KeyDown(sender As Object, e As KeyEventArgs) Handles Me.KeyDown
        Try
    ...
    Private Sub tstxtbillno_Validating(sender As Object, e As CancelEventArgs) Handles tstxtbillno.Validating
        Try
            If Val(tstxtbillno.Text.Trim) > 0 Then
                ...
                If TEMPJONO > 0 Then
                    EDIT = True
                    JobOrderForLamination_Load(sender, e)
                    total()
                Else
                    clear()
                    EDIT = False
