...
Public Class OpeningProformaInvoiceDetails
    ...
    Private Sub OpeningProformaInvoiceDetails_KeyDown(sender As Object, e As KeyEventArgs) Handles Me.KeyDown
        Try
    ...
    Private Sub OpeningProformaInvoiceDetails_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        Try
    ...
    Sub FILLGRID()
        Try
            Dim OBJDEPT As New ClsOpeningProformaInvoice
    ...
    Sub showform(ByVal editval As Boolean, ByVal TEMPPORFORMA As Integer)
        Try
            ...
            If (editval = False) Or (editval = True And gridbill.RowCount > 0) Then
                Dim objgdn As New OpeningProformaInvoice
    ...
    Private Sub TOOLEXCEL_Click(sender As Object, e As EventArgs) Handles TOOLEXCEL.Click
        Try
            ...
            Dim PATH As String = Application.StartupPath & "\Opening Proforma Invoice Details.XLS"
            Dim opti As New DevExpress.XtraPrinting.XlsExportOptions
            opti.ShowGridLines = True
            opti.SheetName = "Opening Proforma Invoice Details"
            gridbill.ExportToXls(PATH, opti)
            EXCELCMPHEADER(PATH, "Proforma Invoice Details", gridbill.VisibleColumns.Count + gridbill.GroupCount)
        Catch ex As Exception
            MsgBox("Opening Proforma Invoice Details Excel File is Open, Please Close the File first then try to Export", MsgBoxStyle.Critical)
        End Try
    End Sub
    ...
    Sub SERVERPROPDIRECT(Optional ByVal INVOICEMAIL As Boolean = False, Optional ByVal WHATSAPP As Boolean = False)
        Try
            ...
            For I As Integer = Val(TXTFROM.Text.Trim) To Val(TXTTO.Text.Trim)
                ...
                ALATTACHMENT.Add(Application.StartupPath & "\PIREPORT_" & I & ".pdf")
    ...
    Sub SERVERPROPSELECTED(Optional ByVal INVOICEMAIL As Boolean = False, Optional ByVal WHATSAPP As Boolean = False)
        Try
            ...
            For I As Integer = 0 To Val(SELECTEDROWS.Length - 1)
                ...
                OBJPO.Show()
                OBJPO.Close()
                ALATTACHMENT.Add(Application.StartupPath & "\PIREPORT_" & Val(ROW("TEMPPORFORMA")) & ".pdf")
                FILENAME.Add("PIREPORT_" & Val(ROW("TEMPPORFORMA")) & ".pdf")
            Next
    ...
    Private Sub TOOLPRINT_Click(sender As Object, e As EventArgs) Handles TOOLPRINT.Click
        Try
            ...
            If Val(TXTFROM.Text.Trim) > 0 And Val(TXTTO.Text.Trim) > 0 Then
                ...
                If MsgBox("Wish to Print Opening Proforma Invoice from " & TXTFROM.Text.Trim & " To " & TXTTO.Text.Trim & " ?", MsgBoxStyle.YesNo) = vbYes Then
                    SERVERPROPDIRECT()
                End If
            Else
                If MsgBox("Wish to Print Selected Opening Proforma Invoice ?", MsgBoxStyle.YesNo) = vbYes Then
                    SERVERPROPSELECTED()
                End If
            End If
        Catch ex As Exception
