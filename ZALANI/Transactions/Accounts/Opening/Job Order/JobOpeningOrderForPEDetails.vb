Imports BL
Public Class JobOpeningOrderForPEDetails

    Dim USERADD, USEREDIT, USERVIEW, USERDELETE As Boolean      'USED FOR RIGHT MANAGEMAENT
    Public TEMPJONO As String
    Private Sub JobOpeningOrderForPEDetails_KeyDown(sender As Object, e As KeyEventArgs) Handles Me.KeyDown
        Try
    ...
    Private Sub JobOpeningOrderForPEDetails_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        Try
    ...
    Sub FILLGRID()
        Try
            Dim OBJDEPT As New ClsJobOpeningOrderForPE
    ...
    Sub showform(ByVal editval As Boolean, ByVal TEMPJONO As Integer)
        Try
            ...
            If (editval = False) Or (editval = True And gridbill.RowCount > 0) Then
                Dim objgdn As New JobOpeningOrderForPE
