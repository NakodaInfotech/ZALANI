...
Public Class JobOpeningOrderForPE
    ...
    Private Sub JobOpeningOrderForPE_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        Try
            ...
            If EDIT = True Then
                ...
                Dim OBJCLSINCENTIVE As New ClsJobOpeningOrderForPE
    ...
    Private Sub cmdok_Click(sender As Object, e As EventArgs) Handles cmdok.Click
        ...
        Try
            ...
            Dim objclsPurord As New ClsJobOpeningOrderForPE()
        ...
        Try
            ...
            If EDIT = True Then
                ...
                If lbllocked.Visible = True Then
                    ...
                    Exit Sub
                End If
                TEMPMSG = MsgBox("Delete Opening Job Order For Extrusion?", MsgBoxStyle.YesNo)
                If TEMPMSG = vbYes Then
                    ...
                    Dim ClsINCTAG As New ClsJobOpeningOrderForPE()
                    ClsINCTAG.alParaval = alParaval
                    IntResult = ClsINCTAG.Delete()
                    MsgBox("Opening Job Order For PE Extrusion Deleted")
                    clear()
                    EDIT = False
                End If
            Else
...
LINE1:
            ...
            If TEMPJONO > 0 Then
                EDIT = True
                JobOpeningOrderForPE_Load(sender, e)
            Else
                clear()
                EDIT = False
            End If
...
LINE1:
    ...
    Sub getmax_JONO()
        Dim DTTABLE As New DataTable
        DTTABLE = getmax(" isnull(max(OJO_NO),0) + 1 ", "OpeningJobOrderForPE", "  AND OJO_cmpid=" & CmpId & " and OJO_yearid=" & YearId)
    ...
    Private Sub OpenToolStripButton_Click(sender As Object, e As EventArgs) Handles OpenToolStripButton.Click
        Try
            ...
            Dim objINVDTLS As New JobOpeningOrderForPEDetails
    ...
    Private Sub JobOpeningOrderForPE_KeyDown(sender As Object, e As KeyEventArgs) Handles Me.KeyDown
        Try
