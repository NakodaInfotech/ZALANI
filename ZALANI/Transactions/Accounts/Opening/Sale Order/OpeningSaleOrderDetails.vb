...
Public Class OpeningSaleOrderDetails
    ...
    Private Sub OpeningSaleOrderDetails_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        Try
    ...
    Private Sub cmdok_Click(sender As Object, e As EventArgs) Handles cmdok.Click
        Try
            showform(True, gridbill.GetFocusedRowCellValue("TEMPOSONO"))
        Catch ex As Exception
            Throw ex
        End Try
    End Sub
        ...
        Try
            ...
            If Val(TXTFROM.Text.Trim) > 0 And Val(TXTTO.Text.Trim) > 0 Then
                If Val(TXTFROM.Text.Trim) > Val(TXTTO.Text.Trim) Then
                    MsgBox("Enter Proper OPENINGSO Nos", MsgBoxStyle.Critical)
                    Exit Sub
                Else
                    If MsgBox("Wish to Whatsapp OPENINGSO from " & Val(TXTFROM.Text.Trim) & " To " & Val(TXTTO.Text.Trim) & " ?", MsgBoxStyle.YesNo) = MsgBoxResult.No Then Exit Sub
                    SERVERPROPDIRECT(False, True)
                End If
            Else
                If MsgBox("Wish to Whatsapp Selected OPENINGSO ?", MsgBoxStyle.YesNo) = vbYes Then
        ...
        Try
            ...
            If Val(TXTFROM.Text.Trim) > 0 And Val(TXTTO.Text.Trim) > 0 Then
                If Val(TXTFROM.Text.Trim) > Val(TXTTO.Text.Trim) Then
                    ...
                    Exit Sub
                Else
                    If MsgBox("Wish to Mail OPENINGSO from " & Val(TXTFROM.Text.Trim) & " To " & Val(TXTTO.Text.Trim) & " ?", MsgBoxStyle.YesNo) = MsgBoxResult.No Then Exit Sub
                    SERVERPROPDIRECT(True)
                End If
            Else
                If MsgBox("Wish to Mail Selected OPENINGSO ?", MsgBoxStyle.YesNo) = vbYes Then
    ...
    Sub FILLGRID()
        Try
            Dim OBJDEPT As New ClsOpeningSaleOrder
    ...
    Sub showform(ByVal editval As Boolean, ByVal TEMPOSONO As Integer)
        Try
            ...
            If (editval = False) Or (editval = True And gridbill.RowCount > 0) Then
                Dim objgdn As New OpeningSaleOrder
                objgdn.MdiParent = MDIMain
                objgdn.EDIT = editval
                objgdn.TEMPSONO = TEMPOSONO
                objgdn.Show()
            End If
        Catch ex As Exception
            Throw ex
