...
Public Class InvoiceMasterGridDetails
    ...
    Private Sub InvoiceMasterGridDetails_KeyDown(sender As Object, e As KeyEventArgs) Handles Me.KeyDown
        Try
    ...
    Private Sub InvoiceMasterGridDetails_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        Try
    ...
    Private Sub TOOLEXCEL_Click(sender As Object, e As EventArgs) Handles TOOLEXCEL.Click
        Try
            ...
            opti.SheetName = "Sale Invoice Grid Details"
            gridbill.ExportToXls(PATH, opti)
            EXCELCMPHEADER(PATH, "Sale Invoice Grid Details", gridbill.VisibleColumns.Count + gridbill.GroupCount)
        Catch ex As Exception
            MsgBox("Sale Invoice Grid Details Excel File is Open, Please Close the File first then try to Export", MsgBoxStyle.Critical)
        End Try
    End Sub
