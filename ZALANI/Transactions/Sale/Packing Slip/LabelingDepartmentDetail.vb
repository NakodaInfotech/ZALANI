...
Public Class LabelingDepartmentDetail
    ...
    Private Sub LabellingDepartmentDetail_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        Try
    ...
    Private Sub LabellingDepartmentDetail_KeyDown(sender As Object, e As KeyEventArgs) Handles Me.KeyDown
        Try
    ...
    Private Sub cmdok_Click(sender As Object, e As EventArgs) Handles cmdok.Click
        Try
            showform(True, gridbill.GetFocusedRowCellValue("TEMPLABNO"))
        Catch ex As Exception
            Throw ex
        End Try
    End Sub
    ...
    Private Sub TOOLEXCEL_Click(sender As Object, e As EventArgs) Handles TOOLEXCEL.Click
        Try
            ...
            Dim PATH As String = Application.StartupPath & "\Label Department Details.XLS"
            Dim opti As New DevExpress.XtraPrinting.XlsExportOptions
            opti.ShowGridLines = True
            opti.SheetName = "Label Department Details"
        ...
        Try
            ...
            If Val(TXTFROM.Text.Trim) > 0 And Val(TXTTO.Text.Trim) > 0 Then
                If Val(TXTFROM.Text.Trim) > Val(TXTTO.Text.Trim) Then
                    MsgBox("Enter Proper Label Nos", MsgBoxStyle.Critical)
                    Exit Sub
                Else
                    If MsgBox("Wish to Whatsapp Label from " & Val(TXTFROM.Text.Trim) & " To " & Val(TXTTO.Text.Trim) & " ?", MsgBoxStyle.YesNo) = MsgBoxResult.No Then Exit Sub
                    SERVERPROPDIRECT(False, True)
                End If
            Else
                If MsgBox("Wish to Whatsapp Selected Label ?", MsgBoxStyle.YesNo) = vbYes Then
    ...
    Sub SERVERPROPDIRECT(Optional ByVal INVOICEMAIL As Boolean = False, Optional ByVal WHATSAPP As Boolean = False)
        Try
            ...
            For I As Integer = Val(TXTFROM.Text.Trim) To Val(TXTTO.Text.Trim)
                ...
                OBJPO.FORMULA = "{LABELING.LAB_NO}=" & Val(I) & " and {LABELING.LAB_YEARID}=" & YearId
                OBJPO.PONO = Val(I)
    ...
    Sub SERVERPROPSELECTED(Optional ByVal INVOICEMAIL As Boolean = False, Optional ByVal WHATSAPP As Boolean = False)
        Try
            ...
            For I As Integer = 0 To Val(SELECTEDROWS.Length - 1)
                ...
                OBJPO.PRINTSETTING = PRINTDIALOG
                OBJPO.PRINTPARTYDESIGN = PRINTPARTYDESIGN
                OBJPO.FORMULA = "{LABELING.LAB_NO}=" & Val(ROW("PONO")) & " and {LABELING.LAB_YEARID}=" & YearId
    ...
    Private Sub TOOLMAIL_Click(sender As Object, e As EventArgs) Handles TOOLMAIL.Click
        Try
            ...
            If Val(TXTFROM.Text.Trim) > 0 And Val(TXTTO.Text.Trim) > 0 Then
                ...
                End If
            Else
                If MsgBox("Wish to Mail Selected Label ?", MsgBoxStyle.YesNo) = vbYes Then
    ...
    Sub FILLGRID()
        Try
            Dim OBJDEPT As New ClsLabeling
            Dim DT As DataTable = OBJDEPT.SELECTLABELING(TEMPLABNO, CmpId, YearId)
    ...
    Private Sub TOOLPRINT_Click(sender As Object, e As EventArgs) Handles TOOLPRINT.Click
        Try
            ...
            If Val(TXTFROM.Text.Trim) > 0 And Val(TXTTO.Text.Trim) > 0 Then
                ...
                If MsgBox("Wish to Print Label from " & TXTFROM.Text.Trim & " To " & TXTTO.Text.Trim & " ?", MsgBoxStyle.YesNo) = vbYes Then
                    SERVERPROPDIRECT()
                End If
            Else
                If MsgBox("Wish to Print Selected Label ?", MsgBoxStyle.YesNo) = vbYes Then
                    SERVERPROPSELECTED()
                End If
            End If
        Catch ex As Exception
    ...
    Sub showform(ByVal editval As Boolean, ByVal TEMPLABNO As Integer)
        Try
            ...
            If (editval = False) Or (editval = True And gridbill.RowCount > 0) Then
                Dim objgdn As New LabelingDepartment
                objgdn.MdiParent = MDIMain
                objgdn.EDIT = editval
                objgdn.TEMPLABNO = TEMPLABNO
                objgdn.Show()
            End If
        Catch ex As Exception
            Throw ex
