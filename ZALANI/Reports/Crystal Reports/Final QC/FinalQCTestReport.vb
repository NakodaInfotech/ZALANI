...
Public Class FinalQCTestReport
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "ZALANI.FinalQCTestReport.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedFinalQCTestReport
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As FinalQCTestReport = New FinalQCTestReport()
        rpt.Site = Me.Site
        Return rpt
    End Function
