...
Public Class ProdRecdReport
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "ZALANI.ProdRecdReport.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedProdRecdReport
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As ProdRecdReport = New ProdRecdReport()
        rpt.Site = Me.Site
        Return rpt
    End Function
