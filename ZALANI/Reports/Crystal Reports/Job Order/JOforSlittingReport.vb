...
Public Class JOforSlittingReport
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "JOforSlittingReport.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "ZALANI.JOforSlittingReport.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedJOforSlittingReport
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As JOforSlittingReport = New JOforSlittingReport()
        rpt.Site = Me.Site
        Return rpt
    End Function
