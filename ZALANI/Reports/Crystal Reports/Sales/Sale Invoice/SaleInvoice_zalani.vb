...
Public Class SaleInvoice_zalani
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "ZALANI.SaleInvoice_zalani.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedSaleInvoice_zalani
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As SaleInvoice_zalani = New SaleInvoice_zalani()
        rpt.Site = Me.Site
        Return rpt
    End Function
