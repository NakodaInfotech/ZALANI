...
Public Class ClsDeducteetypeMaster
...
#Region "Function"
    ...
    Public Function SAVE() As Integer
        ...
        Try
            ...
            Dim strCommand As String = "SP_MASTER_DEDUCTEETYPEMASTER_SAVE"
    ...
    Public Function update() As Integer
        ...
        Try
            ...
            'save gradeMaster
            Dim strCommand As String = "SP_MASTER_DEDUCTEETYPEMASTER_UPDATE"
            Dim alParameter As New ArrayList
            With alParameter
                ...
                .Add(New SqlClient.SqlParameter("@yearid", alParaval(5)))
                .Add(New SqlClient.SqlParameter("@transfer", alParaval(6)))
                .Add(New SqlClient.SqlParameter("@DEDUCTEETYPEID", alParaval(7)))
    ...
    Public Function DELETE() As Integer
        ...
        Try
            ...
            'save gradeMaster
            Dim strCommand As String = "SP_MASTER_DEDUCTEETYPEMASTER_DELETE"
            Dim alParameter As New ArrayList
            With alParameter
