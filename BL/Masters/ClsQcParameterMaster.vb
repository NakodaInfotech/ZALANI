Imports DB
Public Class ClsQcParameterMaster
...
#Region "Function"
    ...
    Public Function SAVE() As Integer
        Dim intResult As Integer
        Try
            Dim strcommand As String = "SP_MASTER_QCPARAMETERMASTER_SAVE"
            Dim alParameter As New ArrayList
            With alParameter

                Dim I As Integer = 0
                .Add(New SqlClient.SqlParameter("@QCNAME", alParaval(0)))
    ...
    Public Function UPDATE() As Integer
        ...
        Try
            ...
            Dim strcommand As String = "SP_MASTER_QCPARAMETERMASTER_UPDATE"
            Dim alParameter As New ArrayList
            With alParameter
                ...
                .Add(New SqlClient.SqlParameter("@QCid", alParaval(7)))
