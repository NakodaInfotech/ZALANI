...
Public Class ClsStoreConsumptionReturn
...
#Region "functions"
    ...
    Public Function SAVE() As DataTable
        ...
        Try
            ...
            Dim strCommand As String = "SP_TRANS_STORE_CONSUMPTIONRETURN_SAVE"
            ...
            With alParameter
                ...
                I = I + 1
                .Add(New SqlClient.SqlParameter("@RETURNEDBY", alParaval(I)))
                I = I + 1
    ...
    Public Function UPDATE() As Integer
        ...
        Try
            ...
            Dim strCommand As String = "SP_TRANS_STORE_CONSUMPTIONRETURN_UPDATE"
            Dim alParameter As New ArrayList
            With alParameter
    ...
    Public Function SELECTCONSUMPTIONRETURN() As DataTable

        Dim dtTable As DataTable
        Try

            Dim strCommand As String = "SP_CONSUMPTIONRETURN_FOR_EDIT"
            Dim alParameter As New ArrayList
            With alParameter
                .Add(New SqlClient.SqlParameter("@CONNO", alParaval(0)))
    ...
    Public Function DELETE() As Integer
        Dim intResult As Integer
        Try
            Dim strCommand As String = "SP_TRANS_STORE_CONSUMPTIONRETURN_DELETE"
            Dim alParameter As New ArrayList
            With alParameter
                .Add(New SqlClient.SqlParameter("@CONNO", alParaval(0)))
                .Add(New SqlClient.SqlParameter("@YearID", alParaval(1)))
