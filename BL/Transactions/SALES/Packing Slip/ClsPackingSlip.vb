...
#Region "Functions"
    Public Function SAVE() As DataTable
        ...
        Try
            'save SALE order
            Dim strCommand As String = "SP_TRANS_SALE_PACKINGSLIP_SAVE"
            ...
            With alParameter
                ...
                I = I + 1
                .Add(New SqlClient.SqlParameter("@TOTALPALLETTEWT", alParaval(I)))
                I = I + 1
    ...
    Public Function UPDATE() As Integer
        ...
        Try
            'Update SALE order
            Dim strCommand As String = "SP_TRANS_SALE_PACKINGSLIP_UPDATE"
            Dim alParameter As New ArrayList
            With alParameter
                ...
                .Add(New SqlClient.SqlParameter("@TEMPPSNO", alParaval(I)))
                I = I + 1
            End With
    ...
    Public Function selectPACKING(ByVal PSNO As Integer, ByVal Cmpid As Integer, ByVal YearID As Integer) As DataTable
        Dim dtTable As DataTable
        Try

            Dim strCommand As String = "SP_SELECT_PACKINGSLIP_FOR_EDIT"
            Dim alParameter As New ArrayList
            With alParameter
                .Add(New SqlClient.SqlParameter("@PSNO", PSNO))
    ...
    Public Function Delete() As Integer
        Dim intResult As Integer
        Try
            Dim strCommand As String = "SP_TRANS_SALE_PACKINGSLIP_DELETE"
            Dim alParameter As New ArrayList
            With alParameter
                .Add(New SqlClient.SqlParameter("@PSNO", alParaval(0)))
