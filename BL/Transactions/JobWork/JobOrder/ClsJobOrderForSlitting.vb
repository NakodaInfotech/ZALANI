Imports DB
Public Class ClsJobOrderForSlitting
...
#Region "Functions"
    Public Function SAVE() As DataTable
        ...
        Try
            'save SALE order
            Dim strCommand As String = "SP_TRANS_JO_SLITTING_SAVE"
    ...
    Public Function UPDATE() As Integer
        ...
        Try
            'Update SALE order
            Dim strCommand As String = "SP_TRANS_JO_SLITTING_UPDATE"
            Dim alParameter As New ArrayList
            With alParameter
    ...
    Public Function selectJOSLITTING(ByVal JONO As Integer, ByVal Cmpid As Integer, ByVal YearID As Integer) As DataTable
        Dim dtTable As DataTable
        Try

            Dim strCommand As String = "SP_SELECTJO_SLITTING_FOR_EDIT"
            Dim alParameter As New ArrayList
            With alParameter
    ...
    Public Function Delete() As Integer
        Dim intResult As Integer
        Try
            Dim strCommand As String = "SP_TRANS_JO_SLITTING_DELETE"
            Dim alParameter As New ArrayList
            With alParameter
