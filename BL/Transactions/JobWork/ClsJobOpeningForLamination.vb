Imports DB
Public Class ClsJobOpeningForLamination
...
#Region "Functions"
    Public Function SAVE() As DataTable
        ...
        Try
            'save SALE order
            Dim strCommand As String = "SP_TRANS_OPENINGJO_LAMINATION_SAVE"
    ...
    Public Function UPDATE() As Integer
        ...
        Try
            'Update SALE order
            Dim strCommand As String = "SP_TRANS_OPENINGJO_LAMINATION_UPDATE"
            Dim alParameter As New ArrayList
            With alParameter
    ...
    Public Function selectJOLAM(ByVal JONO As Integer, ByVal Cmpid As Integer, ByVal YearID As Integer) As DataTable
        ...
        Try
            ...
            Dim strCommand As String = "SP_SELECTOPENINGJO_LAMINATION_FOR_EDIT"
            Dim alParameter As New ArrayList
            With alParameter
    ...
    Public Function Delete() As Integer
        Dim intResult As Integer
        Try
            Dim strCommand As String = "SP_TRANS_OPENINGJO_LAMINATION_DELETE"
            Dim alParameter As New ArrayList
            With alParameter
