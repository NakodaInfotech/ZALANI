...
#Region "Functions"
    ...
    Public Function SAVE() As DataTable
        Try
            'save purchase order
            Dim strCommand As String = "SP_TRANS_PURCHASE_QUALITYCHECK_SAVE"
    ...
    Public Function UPDATE() As Integer
        ...
        Try
            ...
            Dim strCommand As String = "SP_TRANS_PURCHASE_QUALITYCHECK_UPDATE"
            Dim alParameter As New ArrayList
            With alParameter
                Dim I As Integer = 0
                .Add(New SqlClient.SqlParameter("@QCNO", alParaval(I)))
    ...
    Public Function SELECTQC(ByVal QCno As Integer, ByVal Cmpid As Integer, ByVal LocationID As Integer, ByVal YearID As Integer) As DataTable
        Dim dtTable As DataTable
        Try

            Dim strCommand As String = "SP_SELECTQC_FOR_EDIT"
            Dim alParameter As New ArrayList
            With alParameter
    ...
    Public Function DELETE() As Integer
        Dim intResult As Integer
        Try
            Dim strCommand As String = "SP_TRANS_PURCHASE_QUALITYCHECK_DELETE"
            Dim alParameter As New ArrayList
            With alParameter
    ...
    Public Function SAVEIMAGE() As Integer
        Dim INTRESULT As Integer
        Try
            Dim STRCOMMAND As String = "SP_TRANS_PURCHASE_QUALITYCHECK_SAVEIMAGE"
